...
Vector2::Vector2() : x_(0), y_(0) { /* Nothing.  See initialization list */ }
...
double Vector2::magnitude() const { return this->length(); }
...
double Vector2::x() const { return this->x_; }

void Vector2::set_x(double px) { this->x_ = px; }

double Vector2::y() const { return this->y_; }

void Vector2::set_y(double py) { this->y_ = py; }
