...
int Rectangle::area() const { return this->width_ * this->height_; }

int Rectangle::perimeter() const { return 2 * (this->width_ + this->height_); }
...
int Rectangle::width() const { return this->width_; }

void Rectangle::set_width(int pwidth) { this->width_ = pwidth; }

int Rectangle::height() const { return this->height_; }

void Rectangle::set_height(int pheight) { this->height_ = pheight; }
