...
Vector2 Shape::center() const { return this->center_; }

void Shape::set_center(const Vector2 &pcenter) { this->center_ = pcenter; }

HSLAPixel Shape::color() const { return this->color_; }
