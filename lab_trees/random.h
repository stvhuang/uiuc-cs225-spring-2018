...
inline int_fast16_t urand() { return internal::rand(-2); }

inline int_fast16_t urandn(int32_t n) { return urand() % n; }

inline void usrand(uint64_t seed) { internal::rand(seed); }
...
inline Random::Random(uint64_t seed) : mySeed(seed) {}

inline void Random::srand(uint64_t seed) { mySeed = seed; }
...
inline int_fast16_t Random::rand(int32_t n) { return rand() % n; }

inline int_fast16_t Random::operator()() { return rand(); }

inline int_fast16_t Random::operator()(int32_t n) { return rand(n); }
