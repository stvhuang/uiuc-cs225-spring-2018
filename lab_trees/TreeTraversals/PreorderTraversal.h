...
class PreorderTraversal : public TreeTraversal<T> {
  public:
     ...
     */
    PreorderTraversal(typename BinaryTree<T>::Node *root) : root(root) {
        stack.push(root);
    }
     ...
     * Important for the sake of looping through an iterator's contents.
     *
     * @return The iterator object pointing to the element after the end of the
     * traversal.
     */
     ...
     * is popped before the right, thus following the rules of preorder
     * traversals.
     *
