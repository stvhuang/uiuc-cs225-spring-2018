...
void error(string programName) {
    cerr
        ...
        << endl
        << "\tfor random graphs, graphType can be \"random\" and you can "
           "specify"
        << endl
        << "\t  the number of vertices and a random seed if wanted." << endl
        << endl
        << "example: test finding minimum weight on a graph of Europe:" << endl
        << "\t" << programName << " weight europe" << endl
        << endl
        << "example: test minimal spanning tree on a random graph:" << endl
        << "\t" << programName << " mst random" << endl
        << endl
        << "example: test shortest path on a random graph with 8 vertices and "
           "seed 777:"
        << endl
        << "\t" << programName << " path random 8 777" << endl
        << endl;
}
