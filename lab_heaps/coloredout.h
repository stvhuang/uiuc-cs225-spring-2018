...
class colored_out {
  ...
  protected:
    ...
    static bool is_enabled(const std::ostream &out, enable_t e) {
        ...
        return (e == ENABLE) || (e == TTY && was_originally_tty) ||
               (e == COUT && was_originally_tty &&
  ...
  public:
    colored_out() : sendnullchar(false) {}
    ...
    template <typename T>
    static void output_bold(T c, std::ostream &out = std::cout,
                            enable_t enable = COUT) {
    ...
    static void output_bold_digits(std::string str,
