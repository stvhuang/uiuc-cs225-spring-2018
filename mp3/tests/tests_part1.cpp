...
TEST_CASE("List::reverse", "[weight=1][part=1]") {
    ...
    PNG expected;
    expected.readFromFile("tests/expected-reserve.png");
...
TEST_CASE("List::reverseNth #1", "[weight=1][part=1]") {
    ...
    in.readFromFile("tests/alma.png");
    PNG expected;
    expected.readFromFile("tests/expected-reserveN_1.png");
...
TEST_CASE("List::reverseNth #2", "[weight=1][part=1]") {
    ...
    in.readFromFile("tests/alma.png");
    PNG expected;
    expected.readFromFile("tests/expected-reserveN_2.png");
...
TEST_CASE("List::waterfall", "[weight=1][part=1]") {
    ...
    in.readFromFile("tests/alma.png");
    PNG expected;
    expected.readFromFile("tests/expected-waterfall.png");
