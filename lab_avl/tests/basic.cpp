...
TEST_CASE("test_insert_small", "[weight=5]") {
    ...
    REQUIRE(tree_equals_output(str, "tests/soln_test_insert_small.out") ==
            true);
}
...
TEST_CASE("test_insert_big", "[weight=10][valgrind]") {
    ...
    vector<pair<int, string>> elems = {{55, ""}, {45, ""}, {12, ""}, {34, ""},
                                       {56, ""}, {46, ""}, {13, ""}, {35, ""},
                                       {57, ""}, {47, ""}, {14, ""}, {36, ""},
                                       {58, ""}, {48, ""}, {15, ""}, {37, ""}};
    ...
    vector<string> solnFuncCalls = {
        "rotateRight", "rotateRightLeft", "rotateRight", "rotateLeft",
    ...
    vector<int> solnTraversal = {12, 13, 14, 15, 34, 35, 36, 37,
...
TEST_CASE("test_remove_big", "[weight=10][valgrind]") {
    ...
    vector<pair<int, string>> elems = {
        {94, ""}, {87, ""}, {61, ""}, {96, ""}, {76, ""}, {92, ""}, {42, ""},
        {78, ""}, {17, ""}, {11, ""}, {41, ""}, {95, ""}, {36, ""}, {26, ""},
        {23, ""}, {93, ""}, {31, ""}, {3, ""},  {45, ""}, {18, ""}, {73, ""},
        {24, ""}, {74, ""}, {1, ""},  {71, ""}, {82, ""}};
    ...
    vector<string> solnFuncCalls = {
        ...
        "rotateRightLeft", "rotateRight", "rotateLeft",  "rotateLeft",
        "rotateLeftRight", "rotateLeft",  "rotateRight", "rotateRight",
        "rotateLeft",
    };
    ...
    vector<int> solnTraversal = {1,  3,  11, 17, 18, 23, 24, 26, 31, 36,
                                 41, 42, 45, 74, 78, 82, 87, 92, 93, 96};
    vector<string> funcCalls = tree.getFunctionOrder();
    vector<int> inorderTraversal = tree.getInorderTraversal();
    stringstream str;
    tree.print(str, false);
