...
TEST_CASE("StickerSheet::changeMaxStickers() does not discard stickers when "
          "resized larger",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
...
TEST_CASE("StickerSheet::changeMaxStickers() does not discard original "
          "stickers when resized smaller",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::changeMaxStickers() can increase the number of "
          "stickers on an image",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::changeMaxStickers() discards stickers beyond the end "
          "of a smaller StickerSheet",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
// test removeSticker
//
TEST_CASE("StickerSheet::removeSticker() can remove the last sticker",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::removeSticker() can remove the first sticker",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::removeSticker() can remove all stickers",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
//
TEST_CASE("StickerSheet::getSticker() returns the sticker",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::getSticker() returns NULL for a non-existant sticker",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::getSticker() returns NULL for a removed sticker",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
// translate
//
TEST_CASE("StickerSheet::translate() translates a sticker's location",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet::translate() returns false for a non-existant sticker",
          "[weight=1][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("A complex StickerSheet is correct", "[weight=5][part=2]") {
    ...
    i.readFromFile("tests/i.png");
    Image expected;
    expected.readFromFile("tests/expected-3.png");
...
// copy ctor
//
TEST_CASE("StickerSheet's copy constructor makes an independent copy",
          "[weight=2][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
...
TEST_CASE("StickerSheet's assignment operator makes an independent copy",
          "[weight=2][part=2]") {
    Image alma;
    alma.readFromFile("tests/alma.png");
    Image i;
